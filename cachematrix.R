...
## This function Function makeCacheMatrix gets a matrix as an input, sets and
#gets the value of the matrix, sets and gets the value of inverse Matrix. The matrix object
...
makeCacheMatrix <- function(x = matrix()) {
  ...
  setMatrix <- function(y) {
    x <<- y
    invMatrix <<- NULL#<<- operator is used to assign a value to an object in an environment that is different 
